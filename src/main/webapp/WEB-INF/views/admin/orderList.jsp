			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderLIst}">
						...
						<td>${o.orderDate}</td>
						<%
							zhz.model.Order o=(zhz.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							zhz.dao.UserDao userDao=new zhz.dao.UserDao();
						...
						<%
							...
							String paymentType=zhz.model.Payment.findByPaymentId(con,n);
							 %>
